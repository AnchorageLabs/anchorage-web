...
export function HeroVisual() {
  return (
    <div className="relative min-h-[520px] lg:min-h-[660px]">
      <div className="absolute left-8 top-16 h-[29rem] w-[24rem] rotate-[-2deg] bg-[var(--paper)] shadow-[18px_18px_0_rgba(15,23,42,0.16)] lg:left-16" />
      <div className="absolute right-6 top-10 h-[26rem] w-[21rem] rotate-[2.5deg] bg-[var(--paper-soft)] shadow-[14px_14px_0_rgba(15,23,42,0.12)]" />
      <div className="network-orb absolute left-1/2 top-[47%] h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full border-[3px] border-ink bg-[radial-gradient(circle_at_40%_35%,var(--accent),transparent_32%),radial-gradient(circle_at_70%_66%,var(--accent-cyan),transparent_34%)] opacity-95 shadow-[14px_18px_0_rgba(15,23,42,0.16)]" />
      ...
      <div className="absolute bottom-10 left-8 right-8 overflow-hidden rounded-[2rem] border-2 border-ink bg-[var(--terminal)] text-[var(--terminal-text)] shadow-[10px_10px_0_rgba(15,23,42,0.2)]">
